...
// const mongoose = require('mongoose');
// const commentSchema = new mongoose.Schema({
//     student_id: { type: String, required: [true, "Please enter student id"], trim: true },
...
//     localId: { type: String }, // New field for localId
//     fcmToken: { type: String },
//     serverKey: { type: String },
// });
...
const commentSchema = new mongoose.Schema({
  ...
  status: { type: String, required: [true, "Please enter status"] },
  description: { type: String, required: [true, "Please enter description"] },
  localid: { type: String, default: '123' }, // New Field
  createdAt: { type: Date, default: Date.now },
  fcmToken: { type: String },
  serverKey: { type: String },
});
